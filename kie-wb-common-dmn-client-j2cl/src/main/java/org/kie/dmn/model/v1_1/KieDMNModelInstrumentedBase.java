...
public abstract class KieDMNModelInstrumentedBase implements DMNModelInstrumentedBase {
    ...
    public DMNModelInstrumentedBase getParentDRDElement() {
        if (!(this instanceof TDRGElement) && !(this instanceof TDecisionService) && !(this instanceof TArtifact) && (!(this instanceof TItemDefinition) || this.parent == null || !(this.parent instanceof TDefinitions))) {
